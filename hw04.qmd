...
```{r}
# Train/test split
numTrain <- 5000   # number of training instances
...
-   The output function shows that the relationship is almost perfectly linear.
...
-   From the above graph, it is evident that the Error in Testing is high when compared to Training. This means that the model is overfitting to the training set.
